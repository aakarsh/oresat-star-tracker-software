...
def getstardb(year = 1991.25, filename = "/home/debian/oresat-star-tracker-software/oresat_star_tracker/data/hipparcos.dat"):
...
if __name__ == '__main__':
    ...
    print(f"aakarsh {IMAGE_VARIANCE} , THRESH_FACTOR: {THRESH_FACTOR}")
    print("ehhlo")
    bestimage = ""
    maxstars = 0
